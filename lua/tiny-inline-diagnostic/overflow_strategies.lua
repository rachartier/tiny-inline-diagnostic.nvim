...
---@param opts table
---@return table
local function get_message_chunks_for_overflow(message, offset, win_width, opts)
...
---@param opts table
---@return table
function M.apply_wrap(message, need_to_be_under, win_width, opts)
  local offset = 0
  ...
  return get_message_chunks_for_overflow(message, offset, win_width, opts)
end
